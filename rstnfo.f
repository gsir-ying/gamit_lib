...
* MOD TAH 250131: Increased comment to 64 for long site names
...
* MOD TAH 250131: Changed line and requested_line to 512
      character*512 line,requested_line
...
* MOD TAH 250131: Changed line and requested_line to 512
      character*512 line_next    ! Next line in station.info when a data point
...
c     Output: line  -  line containing data tokens 
      ...
      character*5 sitlab  
      character*80 prog_name
* MOD TAH 250131: Changed line *(*) since passed
      character*(*) line
      character*256 message
...
c         old-style -- stop the program  
     ...
     .         ,' with GOOD 1.01, convert with conv_stnfo'           !w20240409
...
c       arrays for values and pointers
      ...
      integer*4 nlist
* MOD TAH 250131: Chnaged passed strings to *(*) for safety.
...
* MOD TAH 250131: Changed line character(*)
      character*(*) line
...
c     20 6-character station.info header tokens.
...
c      that we haven't introduced a bug.
