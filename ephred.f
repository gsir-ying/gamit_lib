...
c     from older routines emntab, soltab, luntab
...
c        call report_stat('FATAL',prog_name,'lib/ephred'
c     .   ,nbodyf,'Error opening planetary ephemeris file',ioerr)
      endif 
...
c     from the routines of gg/utils/emntab.
...
c     Write a format output Sun table from an array of values.
...
c     Write a format output Moon table from an array of values.
